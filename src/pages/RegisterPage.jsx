...
const RegisterPage = () => {
  ...
  const saveDetails = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${VITE_BACKEND_URL}/user/register`, {
        name: name,
        email: email,
        password: password,
      });
  ...
  return (
    <div className="max-w-lg bg-white shadow-lg mx-auto p-7 rounded mt-6">
      ...
      <button
        ...
        className="block w-full mt-6 bg-green-700 text-white rounded-sm px-4 py-2 font-bold hover:bg-green-600 hover:cursor-pointer"
      >
        Login
      </button>
    </div>
